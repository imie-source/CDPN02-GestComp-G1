...
public class SkillPersonAssocPK implements Serializable {
	...
	@Column(name="id_person_person", insertable=false, updatable=false, unique=true, nullable=false)
	private Integer idPersonPerson;

	@Column(name="id_skill_skill", insertable=false, updatable=false, unique=true, nullable=false)
